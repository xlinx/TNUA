...
public class CameraDrog : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(10, 10, 100, 120), "T"+transform.position,guiStyle);
        GUI.Label(new Rect(10, 100, 100, 120), "T"+transform.localEulerAngles,guiStyle);
